...
m[[4]]
a.ray[2,2,2]
#comment:A matrix is a two-dimensional vector where an array is a vector with one or more dimensions.
...
class(d$transect)
str(d)
#Comment: character, numeric,integer,logical and complex data types are present.
